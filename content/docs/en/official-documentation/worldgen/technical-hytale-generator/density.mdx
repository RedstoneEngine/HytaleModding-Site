  ...
  parameters={[
    {
      name: "Lacunarity",
      description:
        "positive decimal number. Impacts the scale of each consecutive octave. A good starting value would be 2.0, which results in each consecutive octave having details that are 2x smaller than the previous. Higher values result in grainier noise.",
    },
    {
      name: "Persistence",
      description:
        "positive decimal number. Multiplies the intensity of each consecutive octave. A good starting value would be 0.5, which results in each consecutive octave being half as strong as the previous.",
    },
    {
      name: "Scale",
      description:
        "positive decimal number. Represents the field’s period distance in blocks. Greater values stretch the noise field outward. A good starting value would be 50.",
    },
    {
      name: "Octaves",
      description:
...
<ParameterList
  parameters={[
    ...
    },
    {
      name: "ScaleXZ",
      description:
        "positive decimal number. Represents the field’s period distance in blocks on the horizontal XZ plane. Greater values stretch the noise field outward. A good starting value would be 50.",
    },
    {
      name: "ScaleY",
      description:
        "positive decimal number. Represents the field’s period distance in blocks on the vertical Y axis. Greater values stretch the noise field outward. A good starting value would be 50.",
    },
    {
      name: "Octaves",
      description:
...
Outputs white noise in the range \[-1, 1].
...
![Example of PositionsCellNoise setup](/assets/official-documentation/worldgen/technical-hytale-generator/density/positions-cell-noise.png) ![Example of PositionsCellNoise setup 2](/assets/official-documentation/worldgen/technical-hytale-generator/density/positions-cell-noise-2.png) ![Example of PositionsCellNoise setup 3](/assets/official-documentation/worldgen/technical-hytale-generator/density/positions-cell-noise-3.png)
...
<ParameterList
  parameters={[
    ...
    },
    {
      name: "MaxDistance",
      description:
        "decimal value. The maximum distance around each Position that it has an effect on the Density field. A good starting value is putting it a bit over half the distance between two of your Position points. Greater values have a greater impact on performance.",
    },
  ]}
/>
...
![Anchored Density example](/assets/official-documentation/worldgen/technical-hytale-generator/density/anchor-density.png)
  ...
  parameters={[
    {
      name: "ChoiceDensity",
      description:
        "Density asset slot. <em>Benefits from a Cache Density.</em> Picks the delimiter to use for a Cell. This field is sampled at each Cell's origin.",
    },
    {
      name: "Delimiters",
      description:
        "list of delimiters. Assign Density fields to cells based on the ChoiceDensity value at the Cell's origin.",
    },
    {
      name: "DefaultValue",
      description:
        "decimal number. This value is used outside of cells. This can happen when the field’s MaxDistance value is smaller than the distance between some Positions.",
    },
  ]}
/>
  ...
  parameters={[
    {
      name: "Curve",
      description:
        "Curve asset slot. Maps the Distance from the origin to a Density value.",
    },
  ]}
/>
...
<ParameterList
  parameters={[
    ...
    },
    {
      name: "Scale",
      description:
        "3D vector asset slot. Determines how much to stretch the Sphere in each direction.",
    },
    {
      name: "NewYAxis",
      description:
        "3D vector asset slot. Let’s you rotate the field around its origin.",
    },
    {
      name: "Spin",
      description:
        "decimal number. Determines the angle in degrees by which to spin the Ellipsoid around its Y axis.",
    },
  ]}
/>
...
<ParameterList
  parameters={[
    ...
    },
    {
      name: "Scale",
      description:
        "3D vector asset slot. Determines how much to stretch the Cube in each direction.",
    },
    {
      name: "Spin",
      description:
  ...
  parameters={[
    {
      name: "AxialCurve",
      description:
        "Curve asset slot. Maps the Distance from the Cylinder’s XZ-plane to a Density value.",
    },
    {
      name: "RadialCurve",
      description:
        "Curve asset slot. Maps the Distance from the Cylinder’s Y axis to a Density value.",
    },
    {
      name: "Spin",
      description:
        "decimal number. Determines the angle in degrees by which to spin the Ellipsoid around its original Y axis.",
    },
    {
      name: "NewYAxis",
      description:
  ...
  parameters={[
    {
      name: "Axis",
      description:
        "3D vector asset slot. Determines the axis from which the distance is used.",
    },
    {
      name: "Curve",
      description:
  ...
  parameters={[
    {
      name: "PlaneNormal",
      description:
        "3D vector asset slot. Determines the direction the plane is facing.",
    },
    {
      name: "Curve",
      description:
  ...
  parameters={[
    {
      name: "Axis",
      description:
        "3D vector asset slot. Determines the axis against which the angle is calculated.",
    },
    {
      name: "Mirror",
      description:
...
<ParameterList
  parameters={[
    { name: "Curve", description: "curve. Maps the input Density value." },
  ]}
/>
  ...
  parameters={[
    {
      name: "Range",
      description:
        "positive decimal number. Greater values result in more smoothing. A good starter value could be 0.2.",
    },
  ]}
/>
...
<ParameterList
  parameters={[
    { name: "WallA", description: "any decimal number" },
    { name: "WallB", description: "any decimal number" },
  ]}
/>
...
<ParameterList
  parameters={[
    ...
    { name: "WallB", description: "any decimal number" },
    {
      name: "Range",
      description:
        "decimal values above 0. Larger values result in smoother transition when the input approaches or exceeds the walls.",
    },
  ]}
/>
...
Reduces the performance cost of its child Density by interpolating between spread-out samples along the Y-axis.
...
- Upstream transformations and warping of the domain could drastically reduce any performance gains.
- If the downstream Density doesn't cost more to generate vertically then this node won't have a significant impact.
  - 3D noise in the downstream will be sped up.
  - 2D noise in the downstream will not be significantly sped up if at all.
- Use the SampleOffset to reduce undesired effects such as alignment of the interpolation artifacts with fluid levels.
- You can use this in combination with a Mix to transition to the full non-sampled version of the child node in areas where precision is important (close to a POI, at the terrain's surface, etc.).
  </Callout>

Below you can see the performance difference between different SampleDistance values for the terrain configuration in the screenshot below:

| SampleDistance | TerrainStage (ms) |
| -------------- | ----------------- |
| None           | 14                |
| 4              | 8                 |
| 8              | 6                 |
  ...
  parameters={[
    {
      name: "SampleDistance",
      description:
        "positive decimal number. Safe starting value: 4.0. Determines how far apart the samples are taken. Larger numbers result in more performance savings but less precise terrain vertically.",
    },
    {
      name: "SampleOffset",
      description:
        "decimal number. Safe starting value: 0.0. Allows for non-zero-aligned sample distribution.",
    },
    {
      name: "Interpolate",
      description:
        "boolean. Enables the smooth interpolation between the samples.",
    },
  ]}
/>
...
<ParameterList
  parameters={[
    {
      name: "Vector",
      description: "3D vector. Reference vector to compare against.",
    },
    {
      name: "VectorProvider",
      description: "procedural vector. Vector to compare.",
    },
  ]}
/>
...
<ParameterList
  parameters={[
    { name: "X", description: "decimal number" },
    { name: "Y", description: "decimal number" },
    { name: "Z", description: "decimal number" },
  ]}
/>
  ...
  parameters={[
    {
      name: "NewYAxis",
      description:
        "3D vector asset. Y-axis of the rotated field rlative to the parent's y-axis.",
    },
    {
      name: "SpinAngle",
      description:
        "decimal number. The angle in degrees to spin the field around the new axis.",
    },
  ]}
/>
...
<ParameterList
  parameters={[
    { name: "SlideX", description: "decimal number" },
    { name: "SlideY", description: "decimal number" },
    { name: "SlideZ", description: "decimal number" },
  ]}
/>
...
<ParameterList
  parameters={[
    ...
    },
    {
      name: "MaxDistance",
      description:
        "positive decimal number. The value represents how big the area of effect is in block units.",
    },
    {
    ...
    },
    {
      name: "PositionsMaxY",
      description:
        "decimal number. Determines the upper Y level bound of the region queried from the Positions field. Any Positions that are at or above this value are ignored.",
    },
    {
      name: "PositionsMinY",
      description:
        "decimal number. Determines the lower Y level bound of the region queried from the Positions field. Any Positions that are below this value are ignored.",
    },
  ]}
/>
...
![Example of PositionsTwist configuration](/assets/official-documentation/worldgen/technical-hytale-generator/density/positions-twist-configuration.png)
...
![Example of Double Twist](/assets/official-documentation/worldgen/technical-hytale-generator/density/double-twist.png)

![Example of Double Twist configuration](/assets/official-documentation/worldgen/technical-hytale-generator/density/double-twist-configuration.png)
...
<ParameterList
  parameters={[
    ...
    {
      name: "ZeroPositionsY",
      description: "boolean value. Flattens the positions input to y=0.",
    },
  ]}
/>
...
<ParameterList
  parameters={[
    {
      name: "SampleRange",
      description: "Distance between samples. Recommended value: 1.",
    },
    {
      name: "WarpFactor",
      description: "With greater values you get more warping.",
    },
    {
      name: "2D",
      description:
        "If true the output of this node is 2D. An internal Cache2D is used.",
    },
    {
      name: "YFor2D",
      description:
        "Default is 0. The Y coordinate used from the input to calculate the gradient from.",
    },
  ]}
/>
  ...
  parameters={[
    {
      name: "WarpScale",
      description:
        "This determines the scale of the internal warper noise field.",
    },
    {
      name: "WarpLacunarity",
      description: "The lacunarity of the internal simplex field.",
    },
    {
      name: "WarpPersistence",
      description: "The persistence of the internal simplex field.",
    },
    { name: "WarpOctaves", description: "The internal field’s octaves." },
    {
      name: "WarpFactor",
      description: "The maximum distance coordinates can be warped.",
    },
  ]}
/>
...
<ParameterList
  parameters={[
    ...
    },
    {
      name: "WarpVector",
      description:
        "Can be any vector. This determines the direction in which the warping happens. Negative values of the factor or the warping density field will result in flipped warping direction.",
    },
  ]}
/>
  ...
  parameters={[
    {
      name: "Reverse",
      description:
        "If true, the node will reverse the origin of the child to the world’s origin, or the origin before the previous Anchor node.",
    },
  ]}
/>
...
It linearly remaps the input's range. The scale is defined by the FromMin, FromMax, ToMin and ToMax parameters. The diagrams below show how those four parameters can be intuitively used to normalize the input.
  ...
  parameters={[
    {
      name: "FromMin",
      description:
        "any decimal number. The value that will be remapped to ToMin.",
    },
    {
      name: "FromMax",
      description:
        "any decimal number. The value that will be remapped to ToMax.",
    },
    {
      name: "ToMin",
      description:
        "any decimal number. The value that FromMin will be remapped to.",
    },
    {
      name: "ToMax",
      description:
        "any decimal number. The value that FromMax will be remapped to.",
    },
  ]}
/>
...
This node lets you reference a DecimalConstant from the WorldStructure. It can operate in 2 modes:
...
<ParameterList
  parameters={[
    {
      name: "BaseHeightName",
      description: "Name of the DecimalConstant to reference.",
    },
    {
      name: "Distance",
      description:
        "Toggles whether to output the raw Y coordinate of the BaseHeight or the distance from the BaseHeight from the query position.",
    },
  ]}
/>
...
Lets you switch between multiple Density branches based on the contextual SwitchState. The SwitchState is a string that can be placed in the context of a Density tree using a SwitchState Density node. The default SwitchState of a Density tree is “Default”.
  ...
  parameters={[
    {
      name: "SwitchCases",
      description:
        "The possible paths to switch into based on the parent's SwitchState.",
    },
  ]}
/>
  ...
  parameters={[
    {
      name: "SwitchState",
      description:
        "Name of the SwitchState to set for the children of this node.",
    },
  ]}
/>
...
<ParameterList
  parameters={[
    { name: "Name", description: "string. The exported Density to import." },
  ]}
/>
---
  ...
  parameters={[
    {
      name: "SingleInstance",
      description:
        "Enable to share the exported for all Imported nodes referencing this key.",
    },
  ]}
/>
